...
import { fetchPlayer, deletePlayer } from '../api/player-api';
import { fetchPlayerLicenses } from '@/features/licenses/api/license-api';
import { fetchCategories } from '@/features/settings/api/category-api';
              ...
              <TableBody>
                {licenses.map((license) => (
                  <TableRow key={license.id}>
                    ...
                    <TableCell>
                      {categoryNameById.get(license.categoryId) ?? 'Unknown category'}
                    </TableCell>
                    <TableCell>
