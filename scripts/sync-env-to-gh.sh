...
Secrets:
  DATABASE_URL, DB_PASSWORD, JWT_SECRET, NEXTAUTH_SECRET, ADMIN_EMAIL, ADMIN_PASSWORD, VPS_SSH_KEY, VPS_HOST_KEY
...
Examples:
  ...
  scripts/sync-env-to-gh.sh --repo ny-randriantsarafara/hoop --dry-run
EOF
}
